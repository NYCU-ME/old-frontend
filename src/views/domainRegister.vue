<template>
    <div class="text-center">
        ...
        <div class="text-md md:text-3xl lg:text-4xl font-bold mb-4">
            www. <input class="bg-gray-300 rounded-2xl" type="text" v-model.trim="customUrl" placeholder="英文字母或數字或符號"> .nycu.me
        </div>
